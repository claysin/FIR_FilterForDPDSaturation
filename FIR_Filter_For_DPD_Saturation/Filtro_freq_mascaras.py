...
# plt.plot(tempo_reamostrado_LTE, abs(xn), color="blue", label="Sinal pré-saturação", lw=1.5)
# plt.plot(tempo_reamostrado_LTE, abs(envoltoria_sinal_saturado), "--", color="red", label="Sinal saturadp", lw=1.5)
# plt.plot(tempo_reamostrado_LTE, abs(xf2), "--", color="black", label="Sinal Filtrado", lw=1.5)
...
# # plt.savefig("/home/clayson/Área de trabalho/Projetos/Latex/Semicro_2025_Clayson/Figuras/envoltoria_comparação_mascara.pdf")
# plt.show()
# ===============================================================================================

#GRAFICO ENVOLTORIA NO TEMPO E METRICA PÓS OTIMIZAÇÃO ===========================================
# plt.style.use("seaborn-v0_8-whitegrid")
...
#GRAFICO RESPOSTA AO IMPULSO DOS COEFICIENTES OTIMIZADOS ===========================================
# # --- Estilo geral
# plt.style.use("seaborn-v0_8-whitegrid")
